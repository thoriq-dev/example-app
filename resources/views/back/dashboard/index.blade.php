...
<html lang="en">
	...
	<head>
		...
		{{-- Custom styles for this template --}}
		<link rel="stylesheet"
			href="{{ asset('assets/css/sb-admin-2-customs.css') }}">
	</head>
			...
			<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
				...
				<div class="sidebar-card d-none d-lg-flex">
					<img class="sidebar-card-illustration mb-2"
						src="{{ asset('assets/img/warning-sign.svg') }}"
						alt="...">
					<p class="text-center mb-2"><strong>Informasi Admin Panel</strong><br> Saat ini masih dalam pengembangan
					</p>
						...
						<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item dropdown no-arrow">
								<a class="nav-link dropdown-toggle"
									...
									aria-haspopup="true"
									aria-expanded="false">
									<span class="mr-2 d-none d-lg-inline text-gray-600 small">Thoriq Nurul Fikri</span>
				...
				<footer class="sticky-footer bg-white">
					<div class="container my-auto">
						<div class="copyright text-center my-auto">
							<p class="mt-4">&copy; 2024 Cherry Company. All rights reserved.</p>
						</div>
					</div>
				</footer>
				<!-- End of Footer -->
